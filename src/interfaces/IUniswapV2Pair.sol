...
interface IUniswapV2Pair is IUniswapV2ERC20 {
    ...
    error UniswapV2Pair__NotFactory();
    error UniswapV2Pair__InsufficientLiquidityMinted();
    error UniswapV2Pair__InsufficientLiquidityBurned();
    error UniswapV2Pair__InsufficientOutputAmount();
    error UniswapV2Pair__InsufficientLiquidity();
    error UniswapV2Pair_InvalidTo();
    error UniswapV2Pair__InsufficientInputAmount();
